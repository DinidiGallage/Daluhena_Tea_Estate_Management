  ...
  return (
    <div className="sidebar-container bg-light d-flex flex-column flex-shrink-0 p-3">
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li className="nav-item">
          <a className="nav-link" onClick={() => toggleDropdown('employeeDetails')}>
            <FontAwesomeIcon icon={faPlusSquare} className="me-2" /> Employee Details
            <FontAwesomeIcon icon={faCaretDown} className="ms-auto" />
          </a>
          {isOpen.employeeDetails && (
            <ul className="submenu">
              <li><Link to="/AddEmployeeDetails" className="nav-link">Add Employee Details</Link></li>
              <li><Link to="/EmployeeDetails" className="nav-link">View Employee Details</Link></li>
            </ul>
          )}
        </li>
        <li className="nav-item">
          <Link to="/reports" className="nav-link">
            <FontAwesomeIcon icon={faListAlt} className="me-2" /> Reports
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/Fianacial" className="nav-link">
            <FontAwesomeIcon icon={faListAlt} className="me-2" /> Final Sales Reports
          </Link>
        </li>
      </ul>
