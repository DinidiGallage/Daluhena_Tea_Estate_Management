...
export default function AddRepair() {
    ...
    function sendData(e) {
        ...
        // POST request to add a new repair record
                            ...
                            <div className="card-body text-dark">
                                ...
                                <form onSubmit={sendData}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <textarea className="form-control" id="details" value={details} onChange={(e) => setDetails(e.target.value)} placeholder="Enter Repair Details" rows="3" required></textarea>
                                    </div>
