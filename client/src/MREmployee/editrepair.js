...
export default function ViewStatus() {
    ...
    const [viewMode, setViewMode] = useState('repair');
    ...
    return (
        <div className="container view-status-container">
                            ...
                            <div className="modal-body">
                                <form>
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" id="item_id" name="item_id" value={editFormData.item_id} onChange={handleEditFormChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="details" className="form-label">Details</label>
                                        <input type="text" className="form-control" id="details" name="details" value={editFormData.details} onChange={handleEditFormChange} />
                                    </div>
                                </form>
                            </div>
